...
@section('content')
    ...
    <div class="container-fluid py-5" style="background: #ccefe7;">
        ...
        <div class="profile-image d-flex justify-content-center py-1">
            <img src="{{ url('storage', $user->profile->photo_path) }}"
                alt="profile_image" class="img-fluid rounded-circle" style="cursor: pointer; height:170px;">
        </div>
        ...
        <div class="container mt-5">
            <form action="{{ route('profiles.update', ['user' => $user ]) }}" class="fw-bold ms-5" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <button type="submit" class="btn tombolhijau w-50 custom-shadow p-3 fw-bold fs-5">Update
                        Profil</button>
                </div>
            </form>
        </div>
