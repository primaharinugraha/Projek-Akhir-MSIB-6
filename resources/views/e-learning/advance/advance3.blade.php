...
@section('title', 'Advance 3')

@section('content')
    <div class="container-fluid py-4">
        <div class="container">
            <h3 class="fw-bold mb-4">Advance 3</h3>
            <div class="row">
                <div class="col-12 col-md-9">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/ZHqdIsLZmns" allowfullscreen></iframe>
                    </div>
                </div>
