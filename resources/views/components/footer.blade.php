<footer class="footer border-top border-dark py-4" id="footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 text-center">
               <img src="{{ asset('image/logosmartmoney.jpeg') }}?v=1" alt="SmartMoney Logo" class="mb-3" style="max-width: 150px;">
               <p class="text-muted">SmartMoney adalah solusi ideal bagi siapa saja yang ingin mengelola keuangan mereka dengan lebih baik. Dengan SmartMoney,  Anda dapat mencapai tujuan keuangan Anda dan mencapai kebebasan Finansial.</p>
            </div>
            <div class="col-lg-4 text-center">
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <p class="text-muted fw-bold ">&copy;2024 SmartMoney, Inc. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>
