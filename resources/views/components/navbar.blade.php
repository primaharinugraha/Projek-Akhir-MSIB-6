      ...
      <ul class="navbar-nav mb-2 mb-lg-0 gap-3"> 
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="{{route('kelolauang')}}">Kelola Uang</a></li>
            <li><a class="dropdown-item" href="{{route('proyek')}}">Proyek</a></li>
          </ul>
        </li>
        <li class="nav-item">
      ...
      <div class=" search d-flex ms-auto me-2 gap-3" role="search">
        ...
        <div class="nav-item dropdown mt-2">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            {{-- bila role admin yang login maka tampil button dashboard --}}
