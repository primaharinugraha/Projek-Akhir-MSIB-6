  ...
  <div class="container">
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav mb-2 mb-lg-0 gap-3"> 
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="{{ route('posts.index')}}">E-learning</a></li>
          </ul>
        </li>
        <li class="nav-item">
      ...
      <div class=" search d-flex ms-auto me-2 gap-3" role="search">
        ...
        <a class="btn tombolhijau custom-shadow px-1 w-50" href="{{ route('register')}}" type="submit">Sign Up</a>
